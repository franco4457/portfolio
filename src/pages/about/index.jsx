          ...
          <div className="flex flex-col space-y-5 items-center  md:flex-row md:space-y-0 md:space-x-4">
            ...
            <div className=" text-center md:text-left md:mt-2 md:w-1/2">
              <p className="text-lg leading-7">
                Hola, mi nombre es
                <span className="font-semibold"> Franco Gutierrez</span>! Soy
                Desarrollador Full Stack y vivo en{' '}
                <span className="font-semibold">Chaco, Argentina</span>
              </p>
              <br />
              <p className="text-lg leading-7">
                Siempre con ganas de aprender{' '}
                <span className="font-semibold">nuevas tecnologias</span> y
                desafiarme a mi mismo, ya sea comenzando un nuevo
                <span className="font-semibold"> proyecto</span> o desarrollando
                un nueva <span className="font-semibold">habilidad</span>.
