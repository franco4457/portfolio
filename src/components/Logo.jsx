  ...
  return (
    ...
    {!reversed
      ? (theme === 'dark' || theme === undefined)
          ? <Image loading='lazy' priority={true} src="/logo_fg2.png" width="50" height="50" alt="Logo-FG" className='h-12 w-12' />
          : <Image loading='lazy' priority={true} src="/image.png" width="50" height="50" alt="Logo-FG" className='h-12 w-12' />
      : (theme !== 'dark')
          ? <Image loading='lazy' priority={true} src="/logo_fg2.png" width="50" height="50" alt="Logo-FG" className='h-12 w-12' />
          : <Image loading='lazy' priority={true} src="/image.png" width="50" height="50" alt="Logo-FG" className='h-12 w-12' />
    }
