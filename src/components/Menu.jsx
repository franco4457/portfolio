...
export default function Menu ({ setMenu }) {
  return (
    <div className="fixed z-1 top-0 origin-top-right transform transition duration-1000 md:hidden opacity-100 scale-100 ">
    {/* // <div class="absolute inset-x-0  top-0 origin-top-right transform p-2 transition md:hidden opacity-100 scale-100"> */}
